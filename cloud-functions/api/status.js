export default async function onRequest(context) {
  ...
  try{
    ...
    const body=new URLSearchParams({api_key:key,format:'json',logs:'1',response_times:'1',response_times_limit:'1440',response_times_average:'1',response_times_start_date:String(now-86400),response_times_end_date:String(now),custom_uptime_ratios:'1-7-30'});
    ...
    return new Response(JSON.stringify({version:'2026-08-30.7-live-external',updated_at:new Date().toISOString(),services}),{status:200,headers});
