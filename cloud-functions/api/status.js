...
export default async function onRequest(context) {
  ...
  try{
    ...
    const body=new URLSearchParams({api_key:key,format:'json',logs:'1',response_times:'1',response_times_limit:'24',response_times_average:'1',response_times_start_date:String(now-86400),response_times_end_date:String(now),custom_uptime_ratios:'1-7-30'});
    ...
    const payload = JSON.stringify({version:'2026-09-05.2-fast',updated_at:new Date().toISOString(),services});
